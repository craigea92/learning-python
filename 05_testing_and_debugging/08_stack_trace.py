...
A stack trace (or "traceback") is a scary-looking error message the Python interpreter prints to the console when it encounters certain problems. 
Stack traces are most common when you're trying to run invalid Python code.

We're going to fix this code block:
...
# Assignment
# Fix the code block and pass all the tests.
