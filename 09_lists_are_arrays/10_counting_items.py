...
# Within the loop, count how many times Potion, Bread, and Shortsword appear by incrementing the potion_count, bread_count and shortsword_count variables respectively.
