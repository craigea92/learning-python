...
# Assignment
# Complete the calculate_total function. The function should return 3 values in this order:
...
def calculate_total(items_purchased, grocery_list):
    ...
    unpurchased_items = [item for item in grocery_list if item not in items_purchased] # Identify unpurchased items
